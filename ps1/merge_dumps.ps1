# Merge two firmware dumps into a single flash image
# covering 0x9000-0x1B5FF (75,264 bytes)
#
# Prerequisites:
#   cargo run --bin ak680-probe -- dump 64 dump_cmd10.bin 10
#   cargo run --bin ak680-probe -- dump 64 firmware.bin 17
...
Write-Host "Load in IDA: ARM Little-endian, rebase to 0x9000, set T=1"